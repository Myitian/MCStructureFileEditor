    ...
    public sealed class NbtFile {
        ...
        public NbtCompound RootTag {
            ...
            set {
                ...
                if (value.Name == null) value.Name = "";//throw new ArgumentException("Root tag must be named.");
                rootTag = value;
            }
        }
        ...
        public NbtFile([NotNull] NbtCompound rootTag)
            : this() {
            RootTag = rootTag ?? throw new ArgumentNullException("rootTag");
        }
        ...
        public NbtFile([NotNull] Stream stream)
            : this()
        {
            if (stream == null) throw new ArgumentNullException("stream");
            LoadFromStream(stream, NbtCompression.AutoDetect, null);
        }
